...
plt.rcParams.update({'font.size':8, 'font.family':'serif','text.usetex':False})
#plt.rc('axes', prop_cycle=(cycler('marker', ['o', 's', '^', 'h', '*'])))
...
def plot_3d_error(ax,fx,fy,fz,xerror,yerror,zerror,label=None,mark='o'):
    ...
    ax.plot([fx], [fy], [fz], linestyle="None", label=label,marker=mark)
...
#ax.set_prop_cycle(cycler('marker', ['o', 's', '^', 'h', '*']))
#ax.set_prop_cycle(cycler('markerfacecolor', ['b', 'g', 'r', 'y']))

if 1:
    urquhart=[['G341.047-00.252',[1.36,0.03],[3.92,0.04],[0.15,0.02]],
                ['G344.102-00.632',[1.32,0.05],[4.25,0.15],[0.20,0.02]],
                ['G328.138-00.548',[1.22,0.04],[4.38,0.19],[0.46,0.01]],
                ['G332.157-00.070',[1.39,0.09],[4.67,0.31],[0.05,0.00]],
                ['G333.125-00.350',[1.31,0.05],[5.43,0.10],[0.33,0.03]],
                ['G326.601+00.659',[1.64,0.05],[3.60,0.05],[0.42,0.01]],
                ['G327.002-00.170',[2.06,0.01],[3.12,0.02],[0.44,0.01]],
                ['G335.270-00.278',[1.00,0.00],[5.40,0.05],[0.37,0.02]],
                ['G331.386-00.139',[1.36,0.04],[4.38,0.06],[0.47,0.00]],
                ['G013.045-00.186',[1.91,0.04],[3.56,0.14],[0.05,0.00]],
                ['G023.079-00.358',[1.12,0.05],[5.40,0.16],[0.42,0.02]],
                ['G331.104-00.413',[1.29,0.07],[4.25,0.11],[0.43,0.01]],
                ['G049.261-00.318',[1.99,0.03],[3.62,0.07],[0.25,0.02]],
                ['G014.477-00.148',[1.39,0.02],[3.83,0.05],[0.33,0.02]],
                #['G018.179-00.303', Q = 0.85: [1.44,0.02],[3.79,0.03],[0.07,0.01]],
                ['G345.374-00.119',[1.29,0.07],[4.25,0.11],[0.44,0.01]],
                ['G014.226-00.564',[1.48,0.04],[4.20,0.07],[0.45,0.01]],
                ['G017.007+00.732',[1.12,0.02],[5.10,0.08],[0.43,0.02]],
                ['G010.189-00.293',[1.36,0.03],[3.92,0.04],[0.38,0.02]],
                ['G018.929-00.343',[1.39,0.09],[4.67,0.31],[0.05,0.00]],
                ['G305.295+00.164',[1.29,0.07],[4.25,0.11],[0.43,0.01]],
                ['G015.079-00.616',[1.59,0.03],[3.60,0.04],[0.25,0.02]],
                ['G350.219+00.081',[1.79,0.03],[3.00,0.00],[0.45,0.02]],
                ['G024.049+00.495',[1.11,0.03],[4.83,0.11],[0.41,0.02]],
                ['G023.375-00.101',[1.54,0.02],[4.00,0.04],[0.20,0.02]],
                ['G348.239+00.515',[1.29,0.05],[4.17,0.15],[0.36,0.02]],
                ['G353.107+00.696',[1.74,0.04],[4.11,0.06],[0.47,0.01]],
                ['G030.496-00.046',[2.00,0.00],[4.00,0.00],[0.49,0.00]],
                ['G351.213+00.706',[1.39,0.09],[5.00,0.00],[0.48,0.00]],
                ['G343.633-00.163',[1.39,0.02],[3.83,0.05],[0.26,0.02]],]
                    
    for (name,d,g,cinv) in urquhart:
        plot_3d_error(ax,d[0],g[0],cinv[0],d[1],g[1],cinv[1],
                         label=name,mark='^')
        

if 0:
    slices=[[['slice_120_140.n400',[2.25,0.22],[4.10,0.30],[0.36,0.01]],
            ['slice_120_140.n2000',[2.32,0.00],[5.00,0.00],[0.28,0.03]],
            ['slice_120_140.n4000',[2.07,0.09],[5.79,0.29],[0.21,0.02]],],
            [['slice_550_1850.n400',[2.07,0.24],[4.62,0.48],[0.05,0.00]],
            ['slice_550_1850.n2000',[2.08,0.14],[5.75,0.43],[0.06,0.00]],
            ['slice_550_1850.n4000',[2.00,0.00],[6.00,0.00],[0.23,0.02]],],
            [['slice_450_2450.n400',[2.15,0.31],[4.23,0.42],[0.49,0.00]],
            ['slice_450_2450.n2000',[2.22,0.15],[5.31,0.46],[0.37,0.02]],
            ['slice_450_2450.n4000',[2.08,0.14],[5.75,0.43],[0.23,0.02]],]]
            
    for slice1 in slices:
        plot_3d_line(ax,slice1,'thing')
        for (name,d,g,cinv) in slice1:
            plot_3d_error(ax,d[0],g[0],cinv[0],d[1],g[1],cinv[1],
                         label=name,mark='^')
